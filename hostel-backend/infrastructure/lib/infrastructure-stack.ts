...
export class InfrastructureStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // =========================================================================
    // 2. Managed PostgreSQL Database (RDS) - Clean Native Creation
    // =========================================================================

    // Create a brand new, encrypted PostgreSQL database managed entirely by CDK
    const database = new rds.DatabaseInstance(this, "HostelDatabase", {
      engine: rds.DatabaseInstanceEngine.postgres({
        version: rds.PostgresEngineVersion.VER_18, // Use your preferred version
      }),
      vpc,
      vpcSubnets: {
      ...
      credentials: rds.Credentials.fromGeneratedSecret("postgres"), // Auto-generates secret in Secrets Manager!
      storageEncrypted: true, // Native encryption enabled out of the box
